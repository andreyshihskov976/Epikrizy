    ...
    public partial class Pacienty : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if (textBox1.Text != "" && textBox2.Text != "" && textBox3.Text != "" && textBox4.Text != "")
            {
                ...
                MySqlOperations.Insert_Update_Delete(MySqlOperations.MySqlQueries.Insert_Pacienty, null, textBox1.Text, textBox2.Text, textBox3.Text, date, comboBox2.Text, textBox4.Text, MySqlOperations.Select_Text(MySqlOperations.MySqlQueries.Select_ID_Gcgp_ComboBox, null, comboBox1.Text));
                this.Close();
            }
            else
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            {
                string date = dateTimePicker1.Value.Year.ToString() + '-' + dateTimePicker1.Value.Month.ToString() + '-' + dateTimePicker1.Value.Day.ToString();
                MySqlOperations.Insert_Update_Delete(MySqlOperations.MySqlQueries.Update_Pacienty, ID, textBox1.Text, textBox2.Text, textBox3.Text, date, comboBox2.Text, textBox4.Text, MySqlOperations.Select_Text(MySqlOperations.MySqlQueries.Select_ID_Gcgp_ComboBox, null, comboBox1.Text));
                this.Close();
            }
            else
                MessageBox.Show("Поля не заполнены.", "Предупреждение", MessageBoxButtons.OK, MessageBoxIcon.Warning);
